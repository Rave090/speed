...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($date)) {
        $error = "Please fill out the Date field.";
    }
    if (empty($slot)) {
        $error = "Please fill out the slot field.";
    }
...
<input type="date"id="date-input" name="date" min=""/ required>
...
document.getElementById("date-input").setAttribute("min", today);
            ...
            <input type="hidden" name="slot" id="selectedSlot" value="" required>
